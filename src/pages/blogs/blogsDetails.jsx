            ...
            <div className="row row--30">
              <div className="col-lg-8">
                ...
                <div className="blog-details-content">
                  ...
                  <h3 data-aos="fade-up" className="title">The Complete Camtasia</h3>
                  <p data-aos="fade-up">
                    Excepteur sint occaecat cupidatat non proident sunt in culpa
                    qui officia deserunt mollit anim id est laborum. Sed ut
                    perspiciatis unde omnis iste natus error sit voluptatem
                  ...
                  <p data-aos="fade-up">
                    ...
                    quis nostrud exerec tation ullamco laboris nis aliquip
                  ...
                  <h3 data-aos="fade-up" className="title">Intrinsic Motivation</h3>
                  <p data-aos="fade-up">
                    Excepteur sint occaecat cupidatat non proident sunt in culpa
                    qui officia deserunt mollit anim id est laborum. Sed ut
                    perspiciatis unde omnis iste natus error sit voluptatem
                      ...
                      <div className="content latest-post-list">
                        ...
                        <div className="latest-post">
                          <div className="thumbnail">
                            <Link href="/blogs/blogsDetails">
                              <img
                                src="/assets/images/blog/small-post-02.jpg"
                                alt="Blog Images"
                              />
                            </Link>
                          </div>
                        ...
                        <div className="latest-post">
                          <div className="thumbnail">
                            <Link href="/blogs/blogsDetails">
                              <img
                                src="/assets/images/blog/small-post-03.jpg"
                                alt="Blog Images"
                              />
                            </Link>
                          </div>
